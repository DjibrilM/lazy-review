                ...
                <div key={model.id} className="space-y-3">
                    ...
                    >
                        <div className="flex min-w-0 items-center gap-3">
                            <div
                                className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-white ${model.id.toUpperCase().includes('QWEN') ? 'bg-blue-500' : 'bg-indigo-500'
                                    }`}
                            >
...
<div className="mt-5 flex justify-end">
                                        ...
                                        >
                                            <Visible visible={downloads[model.id]?.status === 'downloading'} fallback={'Download'}>
                                                'Downloading...'
                                            </Visible>
                                        </Button>
                                    </div>
