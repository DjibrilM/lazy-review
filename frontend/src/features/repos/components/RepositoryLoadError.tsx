            ...
            <div className="w-full max-w-sm overflow-hidden rounded-md border border-border bg-card">
                <div className="flex items-start gap-3 px-4 py-4">
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <Visible visible={failureCount > 0}>
                            (
                            <p className="mt-1.5 text-[10px] text-muted-foreground/70">
                                ...
                                <Visible visible={failureCount === 1} fallback={'times'}>
                                    'time'
                                </Visible>.
                            </p>
</Visible>
                        ...
                        >
                            <Visible visible={isRetrying} fallback={(
                                <RefreshCw className="h-3.5 w-3.5" />
                            )}>
                                (
                                <Loader2 className="h-3.5 w-3.5 animate-spin" />
</Visible>
                            <Visible visible={isRetrying} fallback={'Try again'}>
                                'Retrying…'
                            </Visible>
                        </Button>
                    </div>
