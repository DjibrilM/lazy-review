            ...
            <div className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-white/10 bg-zinc-950/80 p-6 shadow-2xl backdrop-blur-xl animate-in zoom-in-95 duration-200">
                ...
                <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/10 text-white ring-1 ring-white/20">
                        <Visible visible={isCredentials} fallback={isFeedback ? (
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <Visible visible={requestQueue.length > 1}>
                                (
                ...
                <Visible visible={isCredentials && currentRequest.keys}>
                            ...
                            return (
                                <div key={key} className="space-y-1">
                                    ...
                                    <div className="relative flex items-center">
                                        ...
                                        >
                                            <Visible visible={isVisible} fallback={<Eye className="h-4 w-4" />}>
...
<div className="my-5 space-y-2">
                ...
                <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 border-t border-white/5 pt-4">
                    ...
                    >
                        ...
                        <Visible visible={isCredentials} fallback={isFeedback && feedbackText.trim() !== ''
                            ? 'Submit Feedback'
                            : 'Confirm Procedure'}>
                            'Submit Secrets'
                        </Visible>
                        <span className="text-[10px] opacity-70 ml-1">
                            <Visible visible={isCredentials || isFeedback} fallback={'(Enter)'}>
                                '(⌘+Enter)'
                            </Visible>
                        </span>
                    </Button>
